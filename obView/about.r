function(){
        tabPanel("About",
                 ...
                 h4("About Us"),
                 p("This a risk visualization web application developed using the 'shiny' package in R version 3.1.1. It was proudly developed by Dr. Levi Waldron, Jasmine Abdelnabi, Marcel Ramos, Finn Schubert, 
